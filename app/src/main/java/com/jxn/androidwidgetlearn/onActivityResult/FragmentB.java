...
public class FragmentB extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mTextView.setText("FragmentB");
        mTextView.setBackgroundColor(Color.BLUE);
        getChildFragmentManager().beginTransaction().add(R.id.fragment_container, new FragmentC()).commit();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.i(Constant.TAG, "FragmentB onActivityResult：" + resultCode);
    }
}
